          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            <div style={{
              ...
              <div>
                ...
                <p style={{ fontSize: '0.85rem', lineHeight: 1.8, maxWidth: '280px', color: 'rgba(255,255,255,0.35)' }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
                  {['hola@campervaneco.com', '+34 900 123 456', 'Barcelona, España'].map((item) => (
                    <p key={item} style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.4)' }}>{item}</p>
                  ))}
                </div>
              </div>
            </div>
            ...
            <div style={{
              ...
              <p>© 2025 CamperVan Co. Todos los derechos reservados.</p>
              <p>Hecho con cariño y muchos kilómetros.</p>
            </div>
          </div>
        </footer>
      </body>
